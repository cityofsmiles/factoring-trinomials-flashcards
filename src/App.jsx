...
export default function App() {
  ...
  const base =
    import.meta.env.MODE === "development"
      ? "/flashcards.json"
      : "https://cityofsmiles.github.io/factoring-trinomials-flashcards/flashcards.json";
  ...
  return (
    <div className="flashcards-container">
      <h1>Factoring Trinomials Flashcards</h1>
      ...
      <input
        ...
        placeholder="Type factored form, e.g. (2x + 1)(x - 9)"
